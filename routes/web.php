...
Route::get('trucks','TruckController@index')->name('trucks.index');
Route::get('trucks/edit/{id}','TruckController@edit')->name('trucks.edit');
Route::get('trucks/delete/{id}','TruckController@delete')->name('trucks.delete');

Route::post('trucks/save','TruckController@save')->name('trucks.save');

Route::get('trucks/create','TruckController@create')->name('trucks.create');
Route::post('trucks/store','TruckController@store')->name('trucks.store');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('users/userprofile', 'UserController@userprofile')->name('users.userprofile');
    ...
    Route::post('uploads/remove-media','UploadController@removeMedia');
