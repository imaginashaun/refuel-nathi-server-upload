...
Route::post('testpay', 'PayFastController@testpay');
Route::post('paymentnotify', 'PayFastController@paymentnotify');
Route::get('paymentreturn', 'PayFastController@paymentreturn');
Route::post('paymentcancelled', 'PayFastController@paymentcancelled');

Route::get('testpay', 'PayFastController@testpay');
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('membership/user/{id}', 'API\MemberShipController@CheckMembership');
    Route::get('trucks/locations/{id}', 'API\TruckController@getTrucks');
    Route::get('trucks/slots/{id}', 'API\TruckController@getTimes');
    Route::post('vehicles/save','API\VehicleController@Store');
    Route::get('vehicles/all/{id}', 'API\VehicleController@vehicles');
    Route::get('vehicles/remove/{id}', 'API\VehicleController@removevehicle');

    Route::put('vehicles/update/{id}', 'API\VehicleController@update');
    Route::get('membership/product', 'API\ProductAPIController@subscription');

    Route::post('nearestmarket', 'API\MarketAPIController@ClosestMarket');
