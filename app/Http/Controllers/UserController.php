...
class UserController extends Controller
{
    ...
    public function profile()
    {
        ...
        $user->givePermissionTo('drivers.index');
        $mediaItems = $user->getMedia('documents');
        unset($user->password);
        $customFields = false;
...
//        dd($customFieldsValues);
        ...
        return view('settings.users.profile', compact(['user', 'role', 'rolesSelected', 'customFields', 'customFieldsValues','mediaItems']));
    }
...
//        dd($customFieldsValues);
        ...
        return view('settings.users.user_profile', compact(['user', 'role', 'rolesSelected', 'customFields', 'customFieldsValues','mediaItems']));    }
