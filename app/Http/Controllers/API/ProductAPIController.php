...
//            $product['options'] = DB::select("select * from options");
//            $product['option_groups'] = DB::select("select * from option_groups");
        }
    ...
    {
        $product = $this->productRepository->subscriptionproduct();
