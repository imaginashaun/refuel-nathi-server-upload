...
class MarketController extends Controller
{
    ...
    public function store(CreateMarketRequest $request)
    {
        ...
        try {
            ...
            if (isset($input['company_documents']) && $input['company_documents']) {
                $cacheUpload = $this->uploadRepository->getByUuid($input['company_documents']);
                $mediaItem = $cacheUpload->getMedia('company_documents')->first();
                $mediaItem->copy($market, 'company_documents');
            }
