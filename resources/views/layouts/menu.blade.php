...
@can('trucks.index')
    ...
    <li class="nav-item">
        <a class="nav-link {{ Request::is('trucks*') ? 'active' : '' }}" href="#">@if($icons)<i class="nav-icon fa fa-truck"></i>@endif<p>Trucks </p></a>
        <ul class="nav nav-treeview">

            @can('trucks.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('trucks*') ? 'active' : '' }}" href="{!! route('trucks.index') !!}">@if($icons)<i class="nav-icon fa fa-truck"></i>@endif<p>Trucks </p></a>
