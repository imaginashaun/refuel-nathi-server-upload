...
<div class="form-group row col-md-4 col-sm-12">
    ...
    {!! Form::label('order_date','Allocated Time', ['class' => 'col-4 control-label']) !!}
    <div class="col-8">
        <p>{!! $order->allocated_time !!}</p>
    </div>
    {!! Form::label('order_date','Suggested Driver', ['class' => 'col-4 control-label']) !!}
    <div class="col-8">
      @if($order->suggested_driver->user)  <p>{!! $order->suggested_driver->user->name!!}</p> @else  @endif
    </div>
